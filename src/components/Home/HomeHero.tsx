            ...
            <SlideUp delay={0.4} duration={0.8}>
              <div className="pt-8">
                <Button
                  asChild
                  size="lg"
                  className="hero-primary-button font-semibold px-10 py-5 text-xl rounded-none shadow-lg hover:shadow-xl transition-all hover:scale-105"
                >
          ...
          <div className="lg:col-span-4 flex justify-center items-center">
            <div className="relative">
              <FadeIn delay={0.5} duration={1}>
                <div className="w-72 h-72 lg:w-96 lg:h-96 xl:w-[28rem] xl:h-[28rem] bg-[#2D5016] rounded-full flex items-center justify-center opacity-90 shadow-2xl">
                  <Image
